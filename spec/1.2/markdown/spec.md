...
[yaml-core](http://lists.sourceforge.net/lists/listinfo/yaml-core) mailing
list.
...
[Block styles] use [indentation] to denote structure; In contrast, [flow
styles] styles rely on explicit [indicators].
