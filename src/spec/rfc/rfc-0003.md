---
title: RFC-0003
description: Only ASCII-word-characters and dash are allowed in anchor names
---

* Target YAML Version: **Undecided**
* RFC Status: **1**
* [RFC Discussion](https://github.com/yaml/yaml-spec/discussions/75)
* Tags: [anchor](https://github.com/yaml/yaml-test-suite/tree/master/test/tags/anchor)
